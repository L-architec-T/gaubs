        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link tm-nav-link" href="javascript:void(0);" onclick="redirectToEditPage()">Mode
                            Edit</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="tm-intro-text-container">
                    <h2 class="tm-text-primary mb-4 tm-section-title" contenteditable="true" data-key="introduction"
                        style="font-family: 'Anta', sans-serif;">Introduction</h2>
                    <p class="mb-4 tm-intro-text" contenteditable="true" data-key="introduction2">
                        Ici se trouvera l'introduction du metier
                        expliquant se qu'ils font.
                    </p>
                    <p class="mb-5 tm-intro-text" contenteditable="true" data-key="introduction3">
    ...
    <div class="container tm-container-gallery">
        <div class="row">
            <div class="text-center col-12">
                <h2 class="tm-text-primary tm-section-title mb-4" contenteditable="true" data-key="galerie"
                    style="font-family: 'Anta', sans-serif;">Galerie</h2>
                <p class="mx-auto tm-work-description" contenteditable="true" data-key="galerie2">
...
<section id="work" class="tm-section-pad-top">
    <div class="container tm-container-gallery">
        <div class="row">
            <div class="text-center col-12">
                <h2 class="tm-text-primary tm-section-title mb-4" contenteditable="true" data-key="what"
                    style="font-family: 'Anta', sans-serif;">Où sommes nous ?</h2>
                <p class="mx-auto tm-work-description" contenteditable="true" data-key="what2">
...
<section id="work" class="tm-section-pad-top">
    <div class="container tm-container-gallery">
        <div class="row">
            <div class="text-center col-12">
                <h2 class="tm-text-primary tm-section-title mb-4" data-key="horaires" contenteditable="true"
...
<section id="contact" class="tm-section-pad-top tm-parallax-2">
    <div class="container tm-container-contact">
        <div class="row">
            <div class="col-12">
                <h2 class="mb-4 tm-section-title" contenteditable="true" data-key="Contact"
                    style="font-family: 'Anta', sans-serif;">Contact</h2>
                <div class="mb-5 tm-underline"></div>
                <p class="mb-5" contenteditable="true" data-key="Contact2">
            ...
            <div class="col-sm-12 col-md-6 d-flex align-items-center tm-contact-item">
                <a href="tel:0763568670" class="tm-contact-item-link">
                    ...
                    <span class="mb-0" contenteditable="true" data-key="num">0763568670</span>
                </a>
            </div>
            <div class="col-sm-12 col-md-6 d-flex align-items-center tm-contact-item">
                <a href="mailto:juanita.henneville@gmail.com" class="tm-contact-item-link">
                    <i class="fas fa-3x fa-envelope mr-4"></i>
                    <span class="mb-0" contenteditable="true" data-key="mail">juanita.henneville@gmail.com</span>
                </a>
            </div>
            <!--
            <div class="col-sm-12 col-md-6 d-flex align-items-center tm-contact-item">
